...
export function DashboardHeader({ 
  ...
  return (
    <header className="bg-surface/92 dark:bg-surface/92 backdrop-blur-xl text-primary dark:text-primary sticky top-0 z-40 border-b border-outline-variant/70 dark:border-outline-variant/70 w-full px-4 py-3 md:px-xl md:py-md shadow-[0_12px_36px_rgba(0,0,0,0.2)]">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 min-w-0">
        <div className="order-1 flex items-start sm:items-center justify-between gap-md min-w-0">
          ...
          <button
            onClick={() => signOut()}
            className="lg:hidden rounded-full border border-outline-variant/50 bg-surface-container-low/80 text-on-surface-variant hover:bg-error-container/20 hover:text-error hover:border-error/20 transition-all flex shrink-0 min-h-11 min-w-11 items-center justify-center"
            title="Sair"
            aria-label="Sair"
          >
            <LogOut size={20} />
        ...
        <div className="order-2 lg:order-3 grid grid-cols-3 lg:flex items-center gap-sm w-full sm:w-auto lg:w-auto">
          <button
            onClick={onOpenPjTaxes}
            className="flex justify-center shrink-0 px-sm sm:px-md py-sm rounded-2xl lg:rounded-full border border-tertiary-container/70 bg-tertiary-container/10 text-tertiary-container font-label-md text-[12px] min-[390px]:text-[13px] sm:text-[14px] font-semibold hover:bg-tertiary-container/15 transition-all items-center gap-2 min-h-11"
          >
            <Building2 size={16} />
            <span className="hidden sm:inline">Impostos PJ</span>
            <span className="sm:hidden">PJ</span>
          </button>
          <button className="justify-center shrink-0 px-sm sm:px-md py-sm rounded-2xl lg:rounded-full border border-outline-variant bg-surface-container-low/60 text-on-surface-variant font-label-md text-[12px] min-[390px]:text-[13px] sm:text-[14px] font-semibold hover:bg-surface-container-high hover:text-on-surface transition-all min-h-11 flex items-center gap-2" aria-label="Exportar PDF">
            <FileDown size={16} />
          ...
          <button
            ...
            className="justify-center shrink-0 px-sm sm:px-md py-sm rounded-2xl lg:rounded-full bg-primary text-on-primary font-label-md text-[12px] min-[390px]:text-[13px] sm:text-[14px] font-semibold hover:bg-primary-fixed transition-all shadow-[0_0_18px_rgba(0,230,118,0.22)] min-h-11 flex items-center gap-2"
          >
            <Plus size={16} />
