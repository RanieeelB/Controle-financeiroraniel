...
export function MonthlyAnalysisCard({ data, committedPercentage }: MonthlyAnalysisCardProps) {
  return (
    <div className="glass-card rounded-xl p-md sm:p-lg border-l-2 border-l-tertiary-container bg-tertiary-container/5 mt-md min-w-0">
      <h3 className="font-h2 text-[20px] sm:text-[24px] font-semibold text-on-background mb-xs">Renda comprometida</h3>
      ...
      <p className="text-[12px] text-tertiary-container break-words">{data.description}</p>
    </div>
  );
}
