...
export function SummaryCardsGrid({ data }: SummaryCardsGridProps) {
  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-md">
      {/* Saldo Atual */}
      <div className="glass-card-premium rounded-xl p-md sm:p-lg flex flex-col gap-sm min-w-0">
        ...
        <div className="flex items-baseline gap-sm min-w-0">
          <span className="font-numeral-lg text-[34px] sm:text-[40px] xl:text-[48px] font-bold text-on-background leading-none break-words">
      ...
      <div className="glass-card rounded-xl p-md sm:p-lg flex flex-col gap-sm min-w-0">
        ...
        <div>
          <span className="font-numeral-lg text-[26px] sm:text-[32px] font-semibold text-on-background leading-none break-words">
      ...
      <div className="glass-card rounded-xl p-md sm:p-lg flex flex-col gap-sm border-l-2 border-l-tertiary-container min-w-0">
        ...
        <div>
          <span className="font-numeral-lg text-[26px] sm:text-[32px] font-semibold text-tertiary-container leading-none break-words">
