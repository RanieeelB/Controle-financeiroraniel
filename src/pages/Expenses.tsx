  ...
  return (
    <div className="flex flex-col gap-lg lg:gap-xl min-w-0">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-sm sm:gap-lg">
        <div className="bg-surface-container-low border border-outline-variant rounded-xl p-md sm:p-lg relative overflow-hidden group shadow-[0_0_15px_rgba(255,180,171,0.05)] min-w-0 sm:col-span-2 lg:col-span-1">
